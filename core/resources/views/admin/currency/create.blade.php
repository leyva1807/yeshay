                                            ...
                                            <div class="input-group">
                                                <div class="input-group">
                                                    <span class=" input-group-text">
                                                        @lang('1')<span class="currency-symbol ms-1"></span>
                                                    </span>
                                                    <input type="number" step="any" class="form-control"
                                                        name="conversion_rate"
                                                        value="{{ old('conversion_rate', @$currency ? getAmount(@$currency->conversion_rate) : '') }}"
                                                        required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="any" class="form-control" name="reserve"
                                                    value="{{ old('reserve', @$currency ? getAmount(@$currency->reserve) : '') }}"
                                                    required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="any" class="form-control"
                                                    ...
                                                    value="{{ old('percent_decrease', @$currency ? getAmount(@$currency->percent_decrease) : '') }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="any" class="form-control" name="buy_at"
                                                    value="{{ old('buy_at', @$currency ? getAmount(@$currency->buy_at) : '') }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="any" class="form-control"
                                                    ...
                                                    value="{{ old('percent_increase', @$currency ? getAmount(@$currency->percent_increase) : '') }}"
                                                    required />
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="any" class="form-control" name="sell_at"
                                                    value="{{ old('sell_at', @$currency ? getAmount(@$currency->sell_at) : '') }}"
                                                    required />
                                                <span class="input-group-text">{{ __(gs('cur_text')) }}</span>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control rounded"
                                        ...
                                        value="{{ old('minimum_limit_for_sell', @$currency ? getAmount(@$currency->minimum_limit_for_sell) : '') }}" />
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control rounded"
                                        ...
                                        value="{{ old('maximum_limit_for_sell', @$currency ? getAmount(@$currency->maximum_limit_for_sell) : '') }}" />
                                    <span class="input-group-text currency-symbol d-none"></span>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control rounded"
                                        ...
                                        value="{{ old('fixed_charge_for_sell', @$currency ? getAmount(@$currency->fixed_charge_for_sell) : '') }}" />
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control"
                                        ...
                                        value="{{ old('percent_charge_for_sell', @$currency ? getAmount(@$currency->percent_charge_for_sell) : '') }}" />
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control rounded"
                                        ...
                                        value="{{ old('minimum_limit_for_buy', @$currency ? getAmount(@$currency->minimum_limit_for_buy) : '') }}" />
                                    <span class="input-group-text currency-symbol d-none "></span>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control rounded"
                                        ...
                                        value="{{ old('maximum_limit_for_buy', @$currency ? getAmount(@$currency->maximum_limit_for_buy) : '') }}" />
                                    <span class="input-group-text currency-symbol d-none"></span>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control rounded"
                                        ...
                                        value="{{ old('fixed_charge_for_buy', @$currency ? getAmount(@$currency->fixed_charge_for_buy) : '') }}" />
                                    <div class="input-group-text currency-symbol d-none"></div>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control"
                                        ...
                                        value="{{ old('percent_charge_for_buy', @$currency ? getAmount(@$currency->percent_charge_for_buy) : '') }}" />
                                    <div class="input-group-text">@lang('%')</div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        (function($) {
            ...
            const calculateSellAt = () => {
                console.log("percent increate", percentDecrease, conversionRate);
